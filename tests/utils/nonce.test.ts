...
import { ensureUint8Array, generateNonce, validateNonce } from "../../src/utils/nonce.js";
...
describe("Nonce Utilities", () => {
  ...
  describe("ensureUint8Array", () => {
    ...
    it("should throw for unsupported types", () => {
      expect(() => ensureUint8Array(null as any)).toThrow("Unsupported nonce type");
      expect(() => ensureUint8Array(undefined as any)).toThrow("Unsupported nonce type");
      expect(() => ensureUint8Array({} as any)).toThrow("Unsupported nonce type");
    });
  });
});
